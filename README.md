...
# Creating board
It uses a random number generator that that decides the cordinates for each fruit tile

# Pause menu
The main menu can be access by the pause button in the game
It features these buttons
* Replay button
* Play button
* main menu button

  # Replay button
  The replay button reshuffles the all the tiles on the board such that the previous pattren is not repeated and also all the plays are restarted giving you fresh board
  
  # Play button
  If you press the play button it exits the pause menu allowing you to flip tiles again(you cant press the tiles when in pause mode)
